...
// Скрипти запускаються з кореня репозиторію, API в контейнері — з /app.
// CONTENT_DIR перекриває це, коли контент лежить деінде.
const DIR = join(process.env.CONTENT_DIR ?? join(process.cwd(), "content"), "courses");
